...
def graduate_judge(file_path=None):
    ...
    try:
        ...
        if file_path:
            ...
            if n_sum >= 26:
                n_lst = ["",'専門応用科目群A科目',26,18,26]
                n_sum = n_sum - 26
                m_count = m_count + 1
                m_m_count = m_m_count + 1
            elif (n_sum >= 18) & (n_sum < 26):
                n_lst = ["",'専門応用科目群A科目',26,18,n_sum]
                n_sum = 0
                m_m_count = m_m_count + 1
            else:
                n_lst =  ["",'専門応用科目群A科目',26,18,n_sum]
            ...
            if sentaku2_sum >= 18:
                sentaku2_lst = ["",'選択（専門）',18,12,18]
                sentaku2_sum = sentaku2_sum - 18
                m_count = m_count + 1
                m_m_count = m_m_count + 1
            elif (sentaku2_sum >= 12) & (sentaku2_sum < 18):
                sentaku2_lst = ["",'選択（専門）',18,12,sentaku2_sum]
                sentaku2_sum = 0
                m_m_count = m_m_count + 1
            else:
                sentaku2_lst = ["",'選択（専門）',18,12,sentaku2_sum]
...
root.title("令和3.4年度入学 工学部 知能情報システム ４年次進級＆卒業判定アプリ")
