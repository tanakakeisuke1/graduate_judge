...
def graduate_judge(file_path=None):
    ...
    try:
        ...
        if file_path:
            ...
            if n_sum >= 40: #卒業要件と一致
                n_lst = ["",'専門応用科目群A科目',40,32,40]
                n_sum = n_sum - 40 #卒業要件と一致
                m_count = m_count + 1
                m_m_count = m_m_count + 1
            elif (n_sum >= 32) & (n_sum < 40): #進級以上、卒業未満
                n_lst = ["",'専門応用科目群A科目',40,32,n_sum]
                n_sum = 0
                m_m_count = m_m_count + 1
            else:
                n_lst =  ["",'専門応用科目群A科目',40,32,n_sum]
            ...
            if sentaku2_sum >= 15: #卒業要件と一致
                sentaku2_lst = ["",'選択（専門）',15,11,15]
                sentaku2_sum = sentaku2_sum - 15 #卒業要件と一致
                m_count = m_count + 1
                m_m_count = m_m_count + 1
            elif (sentaku2_sum >= 11) & (sentaku2_sum < 15): #進級以上、卒業未満
                sentaku2_lst = ["",'選択（専門）',15,11,sentaku2_sum]
                sentaku2_sum = 0
                m_m_count = m_m_count + 1
            else:
                sentaku2_lst = ["",'選択（専門）',15,11,sentaku2_sum]
...
root.title("令和５年度入学 工学部 機械システム工学 ４年次進級＆卒業判定アプリ")
