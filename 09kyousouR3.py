...
def graduate_judge(file_path=None):
    ...
    try:
        ...
        if file_path:
            ...
            if n_sum >= 38: #卒業要件と一致
                n_lst = ["",'専門応用科目群A科目',38,30,38]
                n_sum = n_sum - 38 #卒業要件と一致
                m_count = m_count + 1
                m_m_count = m_m_count + 1
            elif (n_sum >= 30) & (n_sum < 38): #進級以上、卒業未満
                n_lst = ["",'専門応用科目群A科目',38,30,n_sum]
                n_sum = 0
                m_m_count = m_m_count + 1
            else:
                n_lst =  ["",'専門応用科目群A科目',38,30,n_sum]
            ...
            if mo_sum >= 34: #卒業＆進級要件と一致
                mo_lst = ["",'専門応用科目群B科目',34,28,34]
                mo_sum = mo_sum - 34 #卒業＆進級要件と一致
                m_count = m_count + 1
                m_m_count = m_m_count + 1
            else:
                mo_lst =  ["",'専門応用科目群B科目',34,28,mo_sum]
                mo_sum = 0
    
            sentaku2_sum = n_sum + mo_sum + p_sum + q_sum + r_sum
            if sentaku2_sum >= 10: #卒業要件と一致
                sentaku2_lst = ["",'選択（専門）',10,8,10]
                sentaku2_sum = sentaku2_sum - 10 #卒業要件と一致
                m_count = m_count + 1
                m_m_count = m_m_count + 1
            elif (sentaku2_sum >= 8) & (sentaku2_sum < 10): #進級以上、卒業未満
                sentaku2_lst = ["",'選択（専門）',10,8,sentaku2_sum]
                sentaku2_sum = 0
                m_m_count = m_m_count + 1
            else:
                sentaku2_lst = ["",'選択（専門）',10,8,sentaku2_sum]
...
root.title("令和３年度入学 工学部 協創経営 ４年次進級＆卒業判定アプリ")
